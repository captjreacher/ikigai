-- Ensure the lead.captured -> contacts projection is installed.
-- This is intentionally idempotent for environments where the contacts table
-- migration partially ran but the public.events trigger is missing.
